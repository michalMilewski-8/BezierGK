...
std::vector<VertexPositionNormal> mini::Mesh::BezierVerts(int width_patches, int height_patches, int type)
{
	...
	std::vector<VertexPositionNormal> verts = std::vector<VertexPositionNormal>();
...
std::vector<unsigned short> mini::Mesh::BezierIdxs(int width_patches, int height_patches)
{
	auto patches = std::vector<unsigned short>();
	for (int i = 0; i < width_patches; i++) {

		for (int j = 0; j < height_patches; j++) {

			patches.push_back((height_patches + 3) * i + j + 0);
			patches.push_back((height_patches + 3) * i + j + 1);
			patches.push_back((height_patches + 3) * i + j + 2);
			patches.push_back((height_patches + 3) * i + j + 3);
							   
			patches.push_back((height_patches + 3) * (i + 1) + j + 0);
			patches.push_back((height_patches + 3) * (i + 1) + j + 1);
			patches.push_back((height_patches + 3) * (i + 1) + j + 2);
			patches.push_back((height_patches + 3) * (i + 1) + j + 3);
							   
			patches.push_back((height_patches + 3) * (i + 2) + j + 0);
			patches.push_back((height_patches + 3) * (i + 2) + j + 1);
			patches.push_back((height_patches + 3) * (i + 2) + j + 2);
			patches.push_back((height_patches + 3) * (i + 2) + j + 3);
							   
			patches.push_back((height_patches + 3) * (i + 3) + j + 0);
